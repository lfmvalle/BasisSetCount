...
Due to their complex mathematical forms, identifying **F**- and **G**-type atomic orbitals proves to be quite hard. Remembering the order in which they are implemented in CRYSTAL is even harder, even after months - or maybe years - of practice.
...
>**INFO:** <br> All the atomic orbitals described here follows the same description and order found in [CRYSTAL 23 User's Manual](https://www.crystal.unito.it/include/manuals/crystal23.pdf).

| Order | Mathematical description of the atomic orbital       | plain-text |
| :---: | :---                                                 | :--- |
|       | **P**-type atomic orbitals                          | |
| 1     | $x$                                                  | p [ x ] |
| 2     | $y$                                                  | p [ y ] |
| 3     | $z$                                                  | p [ z ] |
|       | **D**-type atomic orbitals                           | |
| 1     | $z^2 - x^2 - y^2$                                    | d [ z2 ] |
| 2     | $xz$                                                 | d [ xz ] |
| 3     | $yz$                                                 | d [ yz ] |
| 4     | $x^2 - y^2$                                          | d [ x2y2 ] |
| 5     | $xy$                                                 | d [ xy ] |
|       | **F**-type atomic orbitals                           | |
